## =====================================================================
## Title       : Get-MySqlTables
## Description : Generic function to get a list of tables
## Author      : Önder Mönder
## Date        : 7/24/2025
...
##               -verbose -debug	
## Output      : 
## Usage			: PS> .\Get-MySqlTables -server LocalHost -port 3306 -db Test -verbose -debug
## Tag         : MySQL
## ===================================================================== 
...
function main()
{
	...
	Write-Verbose "Generic function to get a list of tables..."
	Get-MySqlTables $server $port $db
}

function Get-MySqlTables($server, $port, $db)
{
